// This unit was originally taken from Delphi7 source
// directory (SOURCE/VCL/FORMS.PAS) and modified by
// Denis Voituk to correctly work with both old HLP-help
// and new HTML-help.
...
begin
  try
    if integer(FControl) = 8 then exit; {by buster}
...
begin
  ...
  begin
     ...
     Font.Height := ReadInteger('interface', 'FormsFontHeight', -11);
