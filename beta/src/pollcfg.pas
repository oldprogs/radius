...
uses
  ...
  ComCtrls, StdCtrls, MClasses, mGrids, ExtCtrls;
...
type
  TPollSetupForm = class(TForm)
    ...
    bCancel: TButton;
    bHelp: TButton;
    cbPollOnDirect: TCheckBox;
    cbPollOnNormal: TCheckBox;
    lCallMin: TLabel;
    sCallMin: TxSpinEdit;
    ...
    rgRetryTimeoutType: TRadioGroup;
...
//    pofHold in Flags;
    cbPollOnDirect.Checked := IniFile.PollOnDirect;
    cbPollOnNormal.Checked := IniFile.PollOnNormal;
    rgRetryTimeoutType.ItemIndex := IniFile.RetryTimeoutType;
//    pofPollOnDir in Flags;
//  end;
//  FreeObject(r);
...
{    Flags.Free;}
    ...
    IniFile.PollOnDirect := cbPollOnDirect.Checked;
    IniFile.PollOnNormal := cbPollOnNormal.Checked;
    IniFile.RetryTimeoutType := rgRetryTimeoutType.ItemIndex;
    SetLength(s, 4);
